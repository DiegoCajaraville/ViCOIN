...
export class AdminPage implements OnInit {
  ...
  async ngOnInit() {
    ...
    if(this.contractsService.account==("0x76A431B17560D46dE8430435001cBC66ae04De46") || this.contractsService.account == ("0x76A431B17560D46dE8430435001cBC66ae04De46").toLowerCase()){
