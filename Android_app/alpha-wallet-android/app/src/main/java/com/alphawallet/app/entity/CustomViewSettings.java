...
{
    public static final long primaryChain = EthereumNetworkBase.MAINNET_ID;
    ...
    private static final List<TokenInfo> lockedTokens = Arrays.asList(
            ...
            new TokenInfo("0x30FeD49F1808F83a2d1b4cf26C275DE66E4eE950", "Vi-COIN", "ViC", 18, true, MAINNET_ID)
